...
const initialCategories: Category[] = [
  { id: "1", name: "Islamic Studies", description: "General Islamic knowledge", bookCount: 15 },
  { id: "2", name: "Islamic Law", description: "Fiqh and jurisprudence", bookCount: 8 },
  { id: "3", name: "Hadith", description: "Prophetic traditions", bookCount: 12 },
]
